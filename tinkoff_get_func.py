...
async def sprav_price_future(price_base, lots=None, stavka_cb=0.21, figi=None, date_expiration=None, max_percente_first_day=None, future_akcii=False, divid_rub=0, po_formyle_popova=False):
...
async def sprav_price_spread(price_base, spread_real, stavka_cb=0.21, figi=None, date_expiration=None, divid_rub=0):
    stavka = stavka_cb
