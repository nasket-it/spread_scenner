...
from file_zamena_kvartal import Date_expir_akcii
    ...
    async with aiohttp.ClientSession() as session:
        ...
        # Фильтрация по дате
            ...
            if date_obj and tek_data:
                if date_obj > tek_data and dividend_rub > 0 and date_obj <= datetime.strptime(Date_expir_akcii.expir_date_akcii,'%d.%m.%Y').date():
